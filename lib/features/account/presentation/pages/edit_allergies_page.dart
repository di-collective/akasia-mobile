...
import '../cubit/get_allergies/get_allergies_cubit.dart';
...
class EditAllergiesPage<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => sl<GetAllergiesCubit>(),
        ),
        BlocProvider(
...
class __BodyState extends State<_Body> {
  ...
  Future<void> _onGetAllergies() async {
    await BlocProvider.of<GetAllergiesCubit>(context).getAllergies();
  }
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    BlocBuilder<GetAllergiesCubit, GetAllergiesState>(
                      builder: (context, state) {
                        List<AllergyModel> allergies = [];
                        String? errorMesssage;
                        if (state is GetAllergiesLoaded) {
                          allergies = state.allergies;
                        } else if (state is GetAllergiesError) {
                          errorMesssage = state.error.message(context);
                        }

                        return DropdownWidget<AllergyModel>(
                          selectedValue: null,
                          isLoading: state is GetAllergiesLoading,
                          isDisabled: state is GetAllergiesError,
                          hintText: errorMesssage ?? context.locale.choose,
                          ...
                          selectedItemBuilder: allergies.map((allergy) {
                            return Text(
