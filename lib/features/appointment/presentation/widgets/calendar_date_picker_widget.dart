...
///    [CalendarDatePickerWidget] and provides an optional compact view where the
...
class CalendarDatePickerWidget extends StatefulWidget {
  ...
  /// change the [key] to create a new instance of the [CalendarDatePickerWidget], and
...
/// [CalendarDatePickerWidget], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [CalendarDatePickerWidget], which provides a Material Design date picker
///    interface.
///
