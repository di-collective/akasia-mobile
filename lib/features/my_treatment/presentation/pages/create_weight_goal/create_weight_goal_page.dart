...
class CreateWeightGoalPage extends StatefulWidget {
  const CreateWeightGoalPage({
    super.key,
  });

  @override
  State<CreateWeightGoalPage> createState() => _CreateWeightGoalPageState();
}

class _CreateWeightGoalPageState extends State<CreateWeightGoalPage> {
  int _currentPage = 0;
  ...
  void _onSelectedPace(WeightGoalPace? value) {
    if (value != null && value != _selectedPace) {
      setState(() {
        _selectedPace = value;
      });
    }
